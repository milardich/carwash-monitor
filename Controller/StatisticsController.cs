...
namespace CarwashMonitor.Controller
{
    public class StatisticsController : ControllerBase
    {
        ...
        public async Task<ActionResult<StatisticsHighlightsDto>> GetStatisticsHighlightsAsync([FromQuery] DateTime? dateFrom, [FromQuery] DateTime? dateTo)
        {
        ...
        public async Task<ActionResult<StatisticsHighlightsDto>> GetStatisticsSummaryAsync([FromQuery] DateTime? dateFrom, [FromQuery] DateTime? dateTo)
        {
